...
def twoStreamsGraph(x_a,y_a,x_b,y_b,x_label,y_label,colorA,colorB,colorA_label,colorB_label,graph_label,box_string):
	print(graph_label)
	plt.close()
	...
	plt.annotate(box_string, xy=(0.8, 0.625), xycoords='axes fraction',va="center", ha="center",bbox=dict(boxstyle="round", fc="w",alpha=0.2))

	#plt.show()
	fileNameToCreate = graph_label.replace(":","_").replace(" ","_")+".pdf"
	plt.savefig(fileNameToCreate)

def delivarble1Graph(calcRootSquaredErrorVector_test,calcRootSquaredErrorVector_training,algo_type_string,box_string):
	...
	twoStreamsGraph(x_a,y_a,x_b,y_b,x_label,y_label,colorA,colorB,colorA_label,colorB_label,graph_label,box_string)
...
def delivarable1_ALS():
	...
	box_string = hyperparameters.str1()
	delivarble1Graph(calcRootSquaredErrorVector_test,calcRootSquaredErrorVector_training,'Alternating Least Squares',box_string)
